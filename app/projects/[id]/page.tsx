      ...
      <motion.div className="relative z-10 container mx-auto px-4 md:py-36 py-26">
        ...
        <motion.div className="max-w-7xl mx-auto space-y-12">
          ...
          <motion.div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: -20 }} viewport={{ once: true }} className="lg:col-span-1 order-1">
        ...
        >
          <motion.div className="bg-linear-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 max-w-3xl mx-auto">
            ...
            <motion.div className="flex flex-wrap justify-center gap-4">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-semibold transition-all duration-300"
